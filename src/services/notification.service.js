...
async function sendRegistrationEmail({ userId, email, consent }) {
  return fetch(
    `${NOTIFICATION_SERVICE_URL}/api/notifications/email/registration`,
    {
      method: "POST",
...
async function sendPasswordResetEmail({ userId, email, code, consent }) {
  return fetch(
    `${NOTIFICATION_SERVICE_URL}/api/notifications/email/password-reset`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function sendRegistrationSMS({ userId, phone, consent }) {
  return fetch(
    `${NOTIFICATION_SERVICE_URL}/api/notifications/sms/registration`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function sendPasswordResetSMS({ userId, phone, code, consent }) {
  return fetch(
    `${NOTIFICATION_SERVICE_URL}/api/notifications/sms/password-reset`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
